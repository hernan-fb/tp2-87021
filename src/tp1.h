 ...
 *
 * Si alguna de las líneas del archivo se encuentra mal formateada, debe ser
 ...
 * función debe aplicarse a cada pokemon en orden de prioridad (los de menor
 * salud primero).
 *
 * La función a aplicar recibe el pokemon y la variable auxiliar que se le paso
 * a hospital_a_cada_pokemon y devuelve true o false. Si la función devuelve
 * true, se debe seguir aplicando la función a los próximos pokemon si quedan.
 * Si la función devuelve false, no se debe continuar.
 *
 * Devuelve la cantidad de veces que se invocó la función (haya devuelto true o
 * false).
 */
...
/**
 * Devuelve el pokemon con la prioridad indicada (siendo 0 la mas alta
 * prioridad, el pokemon con menos salúd).
 *
